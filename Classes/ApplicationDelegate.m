...
- (id)init {
	self = [super init];
	if(self != nil) {
		self.deviceToken = @"ba660f49 941a01d7 3bdb030d 75eb341b d8d8a971 89f307a1 a6f78c6e 953ae0b6";
		self.payload = @"{\"aps\":{\"alert\":\"This is some fancy message.\",\"badge\":1,\"mutable-content\":1,\"category\":\"category1\"}}";
